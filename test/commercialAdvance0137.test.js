...
test('0.13.7 concrete commercial advance is well worked',()=>{
 ...
 {commercial_advance:true,commercial_advance_type:'QUOTE_SENT',commercial_advance_reason:'Llegó a cotizar',concrete_next_step:true,commercial_discovery_level:'bajo',overall_score:75});
...
test('0.13.7 late is separate from commercial quality',()=>{
 ...
 {commercial_advance:true,commercial_advance_type:'MODE_RECOMMENDATION',useful_recommendation:true,concrete_next_step:true,commercial_discovery_level:'medio',overall_score:80});
