...
test('0.8.0 UI uses persistent batch daily supervisor flow',()=>{const html=fs.readFileSync('public/index.html','utf8');for(const s of ['v0.11.6','Ejecutar supervisor diario','/api/supervisor/daily/start','/api/supervisor/daily/process','OPENAI_API_KEY'])assert.ok(html.includes(s),s)});
