...
function createApp({engine,dailyService,databases,config,telegramAdapter,emailAdapter,bucketAdapter}){
  ...
  app.get('/api',(_q,r)=>r.json({ok:true,service:'SUPERVISOR SCB V3',version,endpoints:['/health','/api/core/status','/api/core/validate-sources','/api/core/run','/api/integrations/status','/api/integrations/email/validate','/api/integrations/email/test','/api/integrations/telegram/test','/api/integrations/bucket/validate','/api/supervisor/report/generate','/api/supervisor/report','/api/supervisor/report/send/telegram','/api/supervisor/report/send/email','/api/supervisor/report/send/all','/api/supervisor/daily/generate','/api/supervisor/daily','/api/supervisor/daily/send/telegram','/api/supervisor/daily/send/email','/api/supervisor/daily/send/all']}));
